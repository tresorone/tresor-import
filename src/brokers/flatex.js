...
// Added
const isBuy = textArr => textArr.some(t => / +Kauf/.test(t));

// havent got a file for this
const isSell = textArr =>
  textArr.some(t => t.includes('Wertpapier Abrechnung Verkauf'));

// Added
const isDividend = textArr => textArr.some(t => /Dividendengutschrift/.test(t));

// Added
export const canParseData = textArr =>
  textArr.some(t => t.includes('flatex Bank AG')) &&
